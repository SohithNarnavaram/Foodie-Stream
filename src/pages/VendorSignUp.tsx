...
import { Eye, EyeOff, Mail, Lock, Store, User, Phone, MapPin, ArrowLeft } from "lucide-react";
...
const VendorSignUp = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-primary/5 via-white to-orange-50 flex items-center justify-center px-4 py-2 overflow-hidden">
      <div className="w-full max-w-md space-y-3 max-h-full overflow-y-auto">
        {/* Header */}
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-gray-600">Join us and start streaming</p>
        </div>

        {/* Sign Up Card */}
        <Card className="p-4 shadow-lg border-0 rounded-2xl">
